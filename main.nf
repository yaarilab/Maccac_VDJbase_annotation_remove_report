...
output:
 set val(name_igblast),file("*_db-pass.tsv") optional true  into g0_12_outputFileTSV0_g0_27, g0_12_outputFileTSV0_g0_19, g0_12_outputFileTSV0_g_8
 set val("reference_set"), file("${reference_set}") optional true  into g0_12_germlineFastaFile1_g_37, g0_12_germlineFastaFile1_g_68
 set val(name_igblast),file("*_db-fail.tsv")  into g0_12_outputFileTSV2_g0_27
...
output:
 set val("passed"), file("${outfile}"+"passed.tsv") optional true  into g0_19_outputFileTSV0_g0_27
...
output:
 set val("passed"), file("${outfile}"+"passed.tsv") optional true  into g11_19_outputFileTSV0_g11_27
...
output:
 set val("passed"), file("${outfile}"+"passed.tsv") optional true  into g21_19_outputFileTSV0_g21_27
